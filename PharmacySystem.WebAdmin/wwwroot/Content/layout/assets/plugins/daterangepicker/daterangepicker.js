...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        //manh them
        var yearcur = moment().startOf('day').year();       
        var endDateTmp = moment().startOf('day');        
        var yearnew = yearcur + 1;
        endDateTmp = endDateTmp.year(yearnew);
        ...
        this.buttonClasses = ['btn', 'btn-small','btn-line'];
        ...
        this.rightCalendar = {
            month: moment([this.endDate.year(), this.endDate.month(), 1, this.endDate.hour(), this.endDate.minute()]),//manh them +1
            calendar: []
        };
    ...
    DateRangePicker.prototype = {
        ...
        updateView: function () {
            ...
            this.rightCalendar.month.month(this.endDate.month()).year(this.endDate.year());//manh them +1
        ...
        updateInputText: function() {
            if (this.element.is('input')) {
                ...
                $("#issueddate_detail").val(this.endDate.format(this.format));
            }
        },
