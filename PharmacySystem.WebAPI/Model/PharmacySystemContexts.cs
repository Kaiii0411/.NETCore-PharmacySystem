...
{
    public partial class PharmacySystemContexts : IdentityDbContext<Users, Roles, Guid>
    {
        public PharmacySystemContexts()
        {
        }

        public PharmacySystemContexts(DbContextOptions<PharmacySystemContexts> options)
            : base(options)
        {
        }
